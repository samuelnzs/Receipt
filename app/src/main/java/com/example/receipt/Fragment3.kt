...
import com.example.receipt.RecyclerViewAdapter.ReceivedReceiptAdapter

class Fragment3 : Fragment() {

    lateinit var recycle : RecyclerView
    private val list = ArrayList<ReceiptInfo>()
    private val adapter: ReceivedReceiptAdapter = ReceivedReceiptAdapter(list)
    ...
    override fun onViewCreated(view: View,savedInstanceState: Bundle?){
        ...
        recycle = view. findViewById(R.id.rcyReceivedReceipt)
